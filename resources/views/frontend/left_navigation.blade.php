                ...
                <ul>
                    <li class="@if (Route::currentRouteName() == 'timeline' || Route::currentRouteName() == 'single.post') active @endif">
                        <a class="flex" href="{{ route('timeline') }}">
                            <img src="{{ asset('storage/images/timeline-2.svg') }}"
                                 alt="Timeline">
                            {{ get_phrase('Timeline') }}
                        </a>
                    </li>

                    <li class="@if (Route::currentRouteName() == 'devotional') active @endif"><a href="{{ route('devotional') }}"><img
                                    src="{{ asset('storage/images/forum.svg') }}"
                                    alt="Timeline">{{ get_phrase('Devotional') }}</a></li>
